package com.producto.producto_service.controller;

import com.producto.producto_service.model.Producto;
...
public class ProductoController {
    ...
    public List<Producto> listarProductos() {
        return List.of(
            ...
            new Producto(3L, "Laptop ASUS", 1200.0),
            new Producto(4L, "Smartphone Samsung", 800.0)
        );
    }
